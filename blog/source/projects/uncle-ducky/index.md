...
{% image https://opengraph.githubassets.com/wjjpku-uncle-ducky/wjjpku/UncleDucky, alt=鸭腿叔叔仓库预览, width=100% %}
...
{% btn https://github.com/wjjpku/UncleDucky, 打开代码仓库, anzhiyufont anzhiyu-icon-github, block center %}
